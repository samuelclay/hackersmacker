...
3. **Commit and push**: Commit all changed files (compiled JS, manifests, source) and push to remote.
...
5. **Remind user** to submit the new extension version to the stores:
